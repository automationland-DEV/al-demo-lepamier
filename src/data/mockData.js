...
export const branches = cities.map((c, i) => {
  ...
  return {
    ...
    phone: generatePhone(),
    email: `branch.${c.code.toLowerCase()}@lepalmier.vn`,
...
export const recentActivity = [
  { id: 1, type: "checkin", user: "Nguyễn Văn An", text: "vừa check-in phòng 1204 tại Le Palmier Đức Hòa", time: "2 phút trước", icon: "log-in" },
  { id: 2, type: "booking", user: "Trần Thị Bình", text: "đặt 3 đêm phòng Suite tại Le Palmier Hồ Tràm", time: "8 phút trước", icon: "calendar" },
  { id: 3, type: "review", user: "Lê Hoàng Cường", text: "đánh giá 5★ cho khu Le Palmier Hồ Tràm", time: "15 phút trước", icon: "star" },
  { id: 4, type: "checkout", user: "Phạm Minh Dũng", text: "đã trả phòng 805 tại Le Palmier Long An", time: "22 phút trước", icon: "log-out" },
  { id: 5, type: "service", user: "Khách VIP", text: "yêu cầu dịch vụ spa 60' tại Le Palmier Tây Ninh", time: "35 phút trước", icon: "sparkles" },
  { id: 6, type: "issue", user: "Bùi Phương Linh", text: "báo lỗi điều hòa phòng 304 - Le Palmier Hồ Tràm", time: "1 giờ trước", icon: "alert" },
  { id: 7, type: "booking", user: "Hoàng Khánh My", text: "hủy đặt phòng tại Le Palmier Tây Ninh", time: "1 giờ trước", icon: "x" },
  { id: 8, type: "checkin", user: "Vũ Quốc Nam", text: "check-in sớm phòng 612 tại Le Palmier Đức Hòa", time: "2 giờ trước", icon: "log-in" },
];
...
export const taskList = [
  ...
  { id: 3, title: "Kiểm kê minibar tầng 5-12", branch: "Le Palmier Đức Hòa", due: "Hôm nay", priority: "medium", done: true },
  { id: 4, title: "Đào tạo nhân viên mới quy trình check-in", branch: "Le Palmier Hồ Tràm", due: "Mai", priority: "medium", done: false },
  { id: 5, title: "Đặt vật tư cho mùa cao điểm", branch: "Le Palmier Tây Ninh", due: "Tuần này", priority: "low", done: false },
